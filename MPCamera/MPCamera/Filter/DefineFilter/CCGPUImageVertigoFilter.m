...
#import "CCGPUImageVertigoFilter.h"

NSString * const kCCGPUImageVertigoFilterShaderString = SHADER_STRING
(
...
@implementation CCGPUImageVertigoFilter

- (instancetype)init {
    self = [super initWithFragmentShaderFromString:kCCGPUImageVertigoFilterShaderString];
    return self;
}
