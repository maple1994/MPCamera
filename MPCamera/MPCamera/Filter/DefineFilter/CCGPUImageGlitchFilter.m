...
#import "CCGPUImageGlitchFilter.h"

NSString * const kCCGPUImageGlitchFilterShaderString = SHADER_STRING
(
...
@implementation CCGPUImageGlitchFilter

- (instancetype)init {
    self = [super initWithFragmentShaderFromString:kCCGPUImageGlitchFilterShaderString];
    return self;
}
