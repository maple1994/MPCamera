...
@interface MPFilterCategoryView ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation MPFilterCategoryView
...
- (void)commonInit {
    ...
    [_collectionView registerClass:[MPFilterCategoryCell class] forCellWithReuseIdentifier:kFilterCategoryReuseIdentifier];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MPFilterCategoryCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kFilterCategoryReuseIdentifier forIndexPath:indexPath];
